import{_ as n,a,b as p,c as e}from"./chunks/modular-architecture.-LfbinGq.js";import{_ as l,c as t,o as i,ah as c}from"./chunks/framework.CmswSjfi.js";const k=JSON.parse('{"title":"Структура Vue 3 проекта","description":"","frontmatter":{},"headers":[],"relativePath":"ru/development/project-structure.md","filePath":"ru/development/project-structure.md","lastUpdated":1747025254000}'),o={name:"ru/development/project-structure.md"};function r(d,s,u,m,v,h){return i(),t("div",null,s[0]||(s[0]=[c(`<h1 id="структура-vue-3-проекта" tabindex="-1">Структура Vue 3 проекта <a class="header-anchor" href="#структура-vue-3-проекта" aria-label="Permalink to &quot;Структура Vue 3 проекта&quot;">​</a></h1><h2 id="какие-бывают-структуры-фаилов-для-vue-3-проектов" tabindex="-1">Какие бывают структуры файлов для Vue 3 проектов? <a class="header-anchor" href="#какие-бывают-структуры-фаилов-для-vue-3-проектов" aria-label="Permalink to &quot;Какие бывают структуры файлов для Vue 3 проектов?&quot;">​</a></h2><details class="details custom-block"><summary>Плоская структура</summary><p>При запуске небольшого проекта Vue, такого как Proof of Concept, вы можете предпочесть простую структуру папок, чтобы избежать сложностей:</p><div class="language-txt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/src</span></span>
...
<span class="line"><span>|   |-- ...</span></span>
<span class="line"><span>|-- App.vue</span></span>
<span class="line"><span>|-- main.js</span></span></code></pre></div></details><details class="details custom-block"><summary>Модульный дизайн</summary><p>Модульная архитектура инкапсулирует каждую функцию или предметную область, повышая поддерживаемость и готовя к потенциальной эволюции в сторону микрофронтендов:</p><div class="language-txt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/src</span></span>
