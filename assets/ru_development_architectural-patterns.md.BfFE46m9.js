...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">stopLoading</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre></div><p>This example uses <code>useId</code>, which appeared in <code>Vue 3.5</code></p><p>For earlier versions, you can use any function to generate a unique id.</p></details>`,8),r=[k];function d(E,c,o,g,u,y){return a(),n("div",null,r)}const A=s(h,[["render",d]]);export{v as __pageData,A as default};
