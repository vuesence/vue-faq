...
::: details Какая кофигурация компьютера подходит для фронтенд разработки?
...
Работать так значительно производительней (MySQL, вебсервера, Docker крутятся на Linux быстрей и надёжней, да и Nodе.js), комфортней и тише. Кулер в мини-ПК включается только на пару секунд при загрузке ОС.
