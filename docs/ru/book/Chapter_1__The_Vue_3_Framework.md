...
Поскольку этот метод использования Vue не так уж распространен (или популярен),
мы сосредоточимся на более важных вещах и будем использовать **сборщик** для
...
при использовании сборщика](/ru/book/images/Figure_1.01_B18602.jpg)
