...
::: tip Совет
Функция `setImmediate()` [помечена](https://developer.mozilla.org/en-US/docs/Web/API/Window/setImmediate) как deprecated в `JavaScript` `Web API`, пользоваться ею не стоит.
:::
